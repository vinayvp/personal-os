...
const NoteViewModal: React.FC<NoteViewModalProps> = ({ note, onClose, onEdit, onDelete }) => {
  ...
  return (
    <>
      {/* Custom overlay with close button positioned outside modal */}
      {note && (
        <div className="fixed inset-0 z-50 bg-black/50">
          {/* Close button positioned in top-right corner of screen */}
          <button
            onClick={onClose}
            className="fixed top-4 right-4 z-60 h-10 w-10 rounded-full bg-white/90 hover:bg-white shadow-lg flex items-center justify-center transition-colors"
          ...
          <div className="fixed inset-4 z-50 overflow-hidden">
            <div className="h-full w-full bg-background rounded-lg shadow-xl overflow-hidden">
              <div className="flex flex-col h-full">
                <div className="flex items-center justify-between p-6 border-b shrink-0">
                  <h2 className="text-2xl font-bold flex-1 pr-4">
                    {note.title}
                  </h2>
                ...
                <div className="flex-1 overflow-auto p-6 space-y-4">
                  ...
                  <div className="text-sm text-muted-foreground text-right border-t pt-4">
